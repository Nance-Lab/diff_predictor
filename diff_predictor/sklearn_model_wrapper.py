...
def paramsearch(model, param, X_train, y_train, X_val, y_val):
    '''
...
def train(model, param, num_class: int, X_train : pd.DataFrame, y_train : pd.DataFrame,
    ...
    wrapped_model = ClassifierSkLearnWrapper(model, num_class)
