...
# 1. Return results/metrics
def mpt_paramsearch(X_train, y_train, features, init_params, nfold=5, 
    ...
    (xgboost) best_boost_rounds : int, or None if num_boost_round unspecificed
    ...
    #TODO: is early_stopping_rounds xgboost specific? no, hyperparam tuning, x num w/o improvement, assume in a minima
    ...
    def _gs_helper(var1n, var2n, best_model, best_param, best_eval, **kwargs):
        '''
        Helper function for mpt_paramsearch.
        '''
...
def cv(params, X_train, y_train, features=None, nfold=3,
    ...
    results : pandas.DataFrame
        results of crossvalidated model
    '''
    ...
    if num_boost_round:
        for i in range(num_boost_round):
            for cb in callbacks_before_iter:
                cb(CallbackEnv(model=None, # TODO: scikit learn ways to do this, other packages?
                              cvfolds=cvfolds,
                              iteration=i,
                              begin_iteration=0,
